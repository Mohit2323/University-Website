...
<!-- Mirrored from iglyphic.com/themes/html/thefund/lazyload/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jun 2019 10:59:22 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="color-shicher-wraper">
        <div class="swhicher-button">
            ...
            <div class="backtop-top-check">
                <input type="checkbox" id="backtotop-fixed"/><label for="backtotop-fixed"> Back to top hide/show</label>
            </div>
            <div class="removetopbar">
                <input type="checkbox" id="topbar-checked"/><label for="topbar-checked"> Topbar show/hide </label>
            </div><br/>
            <a href="https://themeforest.net/item/the-fund-charity-crowdfunding-html5-template/21603096?s_rank=1" class="btn">Purchase</a>
        </div>
        <div class="setting-button-wrapper">
            <button type="button" class="setting-button"></button>
        </div>
    </div><!--/.color-shicher-wraper-->
                ...
                <div class="row">
                    <div class="col-sm-6 text-xs-center">
                        <div class="top-bar__contact">
                            <i class="fa fa-envelope"></i> <span class="pdl5">info@thefund.com</span>
    ...
    <nav class="mobile-background-nav">
        <div class="mobile-inner">
            ...
            <ul class="menu-accordion">
                <li><a href="index.html" class="has-submenu">Home <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown">
    ...
    <div class="main-menu-area">
        <div class="container">
            <div class="menu-logo">
                <div class="logo">
                    <a href="index.html" class="logo-index"><img src="images/logo.png" alt="" /></a>
                </div>
                <nav id="easy-menu">
                    <ul class="menu-list">
               ...
               <div class="donate-button-wrap">
                   <a href="donate.html" class="btn base-bg hidden-xs hidden-sm">Donet Now</a>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/causes1.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                        </div>
                                        <div class="our-causes__goal">
                                            <span class="nv-color">GOAL - </span> <span> $1,40,000 </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="our-causes__text-content text-center">
                                    ...
                                    <h4 class="text-uppercase our-causes__title"><a href="#">Raise fund for Healthy Food</a></h4>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/causes2.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                ...
                                <div class="our-causes__text-content text-center">
                                    ...
                                    <h4 class="text-uppercase our-causes__title"><a href="#">Bring Them to Classroom</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consect adipisc elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                                    <a href="#" class="btn">Donet Now</a>
                                </div>
                            </div><!--/.our-causes-->
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/causes3.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                ...
                                <div class="our-causes__text-content text-center">
                                    ...
                                    <h4 class="text-uppercase our-causes__title"><a href="#">Give A Home By Adopt</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consect adipisc elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                                    <a href="#" class="btn">Donet Now</a>
                                </div>
                            </div><!--/.our-causes-->
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/causes4.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                ...
                                <div class="our-causes__text-content text-center">
                                    <div class="progress-item">
                                        <div  class="progress-bg">
                                            <div id='progress-four' class="progress-rate base-bg" data-value='80'>
                                            </div>
                                        </div>
                                        <span class="progress-percent">80%</span>
                                    </div><!--/.progress-item-->
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/causes5.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                ...
                                <div class="our-causes__text-content text-center">
                                    <div class="progress-item">
                                        <div  class="progress-bg">
                                            <div id='progress-five' class="progress-rate base-bg" data-value='80'>
                                            </div>
                                        </div>
                                        <span class="progress-percent">80%</span>
                                    </div><!--/.progress-item-->
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="our-causes">
                                <div class="our-causes__image-wrap pr">
                                    <img data-src="images/causes/cause6.jpg" class="our-causes__image lazy" alt="">
                                    <div class="loader"></div>
                                    <div class="our-causes__percentage base-bg">
                                        <div class="our-causes__rised">
                                            RAISED - <span class="base-color"> $80,500</span>
                                ...
                                <div class="our-causes__text-content text-center">
                                    <div class="progress-item">
                                        <div  class="progress-bg">
                                            <div id='progress-six' class="progress-rate base-bg" data-value='80'>
                                            </div>
                                        </div>
                                        <span class="progress-percent">80%</span>
                                    </div><!--/.progress-item-->
                ...
                <div class="col-md-4">
                    <aside class="sidebar">
                                ...
                                <div class="upcomming-event-carousel" id="upcomming-event-carousel">
                                    <div class="upcomming-event-carousel__item">
                                        <div class="image text-center">
                                            <a href="#"><img class="event-thumbnail lazy" data-src="images/sidebar/upcomming-event1.jpg" alt="">
                                                <div class="loader"></div>
                        ...
                        <div class="widget widget--category">
                            ...
                            <div class="widget__text-content">
                                <ul>
                                    <li><a href="#" class="pdr10">Accommodation</a><span class="post-count">4</span></li>
                                    <li><a href="#" class="pdr10">Children Protection</a><span class="post-count">7</span></li>
                                    <li><a href="#" class="pdr10">Donation Event</a><span class="post-count">2</span></li>
                                    <li><a href="#" class="pdr10">Education</a><span class="post-count">5</span></li>
                                    <li><a href="#" class="pdr10">Food Supply</a><span class="post-count">3</span></li>
                                    <li><a href="#" class="pdr10">Health Care </a><span class="post-count">2</span></li>
                                </ul>
                            ...
                            <div class="widget__text-content">
                                <div class="widget-latest-causes">
                                    <div class="widget-latest-causes__image-wrap">
                                        <a href="#"><img class="widget-latest-causes__thubnail lazy" data-src="images/sidebar/latest-causes1.jpg" alt=""><div class="loader"></div></a>
                                ...
                                <div class="widget-latest-causes">
                                    <div class="widget-latest-causes__image-wrap">
                                        <a href="#"><img class="widget-latest-causes__thubnail lazy" data-src="images/sidebar/latest-causes2.jpg" alt=""><div class="loader"></div></a>
                                ...
                                <div class="widget-latest-causes">
                                    <div class="widget-latest-causes__image-wrap">
                                        <a href="#"><img class="widget-latest-causes__thubnail lazy" data-src="images/sidebar/latest-causes3.jpg" alt=""><div class="loader"></div></a>
                                ...
                                <div class="widget-latest-causes">
                                    <div class="widget-latest-causes__image-wrap">
                                        <a href="#"><img class="widget-latest-causes__thubnail lazy" data-src="images/sidebar/latest-causes4.jpg" alt=""><div class="loader"></div></a>
